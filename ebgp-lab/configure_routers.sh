...
cat router_7.txt | sshpass -p "admin" ssh -oKexAlgorithms=diffie-hellman-group-exchange-sha1 -o StrictHostKeyChecking=no -t admin@172.20.20.17

cat linux_1.txt | sshpass -p "net" ssh -o StrictHostKeyChecking=no -t root@172.20.20.2

cat linux_2.txt | sshpass -p "net" ssh -o StrictHostKeyChecking=no -t root@172.20.20.3

cat linux_3.txt | sshpass -p "net" ssh -o StrictHostKeyChecking=no -t root@172.20.20.4

cat linux_4.txt | sshpass -p "net" ssh -o StrictHostKeyChecking=no -t root@172.20.20.5